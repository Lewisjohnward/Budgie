...
import { buttonVariants } from "@/core/components/uiLibrary/button";
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-sky-950 text-neutral-50 hover:bg-sky-950/80 hover:text-neutral-50 focus:bg-sky-950 focus:text-neutral-50 dark:bg-neutral-50 dark:text-neutral-900 dark:hover:bg-neutral-50 dark:hover:text-neutral-900 dark:focus:bg-neutral-50 dark:focus:text-neutral-900",
        day_today:
          "bg-sky-950/5 text-neutral-900 dark:bg-neutral-800 dark:text-neutral-50",
        day_outside:
