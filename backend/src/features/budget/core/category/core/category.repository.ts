...
export interface CategoryRepository {
  ...
  getCategories(userId: UserId): Promise<db.Category[]>;
  ...
  /**
   * Retrieves months belonging to a specific user within an optional date range.
   *
   * If no range is provided, all months for the user are returned.
   * If only one boundary is provided, the range is treated as open-ended.
   *
   */
  getMonths(
    userId: UserId,
